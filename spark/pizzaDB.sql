...
-- CREATE TABLE pizzaDB.productionLogs (
--           pizzaID STRING NOT NULL,
--           menuName STRING NOT NULL,
--           timestamp TIMESTAMP NOT NULL);

-- CREATE TABLE pizzaDB.productionMeasures (
--           pizzaID STRING NOT NULL,
--           temp DECIMAL(4,1) NOT NULL,
--           timestamp TIMESTAMP NOT NULL);

-- CREATE TABLE pizzaDB.productionStatus (
--           pizzaID STRING NOT NULL,
--           status STRING);

CREATE TABLE pizzaDB.toppings (
          pizzaID STRING NOT NULL,
          topping STRING NOT NULL);

INSERT INTO pizzaDB.toppings
VALUES ('1','mozzarella'),
        ('1','tomato'),
        ('2','cheese'),
        ('2','tomato'),
